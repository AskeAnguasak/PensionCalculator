...
class SmartBuffer {
    ...
    /**
     * Ensures that the internal Buffer is large enough to write at least the given com.pension.calculator.amount of data.
     *
     ...
     *
     * @param amount { Number } The com.pension.calculator.amount to move the read offset forward by.
     */
    skip(amount) {
     ...
     *
     * @param amount { Number } The com.pension.calculator.amount to move the read offset backwards by.
     */
    rewind(amount) {
