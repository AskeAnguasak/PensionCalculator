...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getPension = function (monthlyPayment, interestRate, yearsToPaymentStop, yearsToPayoutStop) {
        var _this = this;
        var url = window.location.origin + "/monthlyPayout?monthlyPayment=" + monthlyPayment
            + "&interestRate=" + interestRate + "&yearsToPaymentStop=" + yearsToPaymentStop + "&yearsToPayoutStop="
            + yearsToPayoutStop;
        this.http.get(url, { responseType: 'text' }).subscribe(function (result) { _this.monthlyPension = result; });
    };
    AppComponent.prototype.getPensionTest = function () {
        var _this = this;
        var url = window.location.origin + "/monthlyPayout?monthlyPayment=2.2"
...
module.exports = __webpack_require__(/*! C:\Users\Aske\workspace\Renteberegner\interestCalculator\interestcalculatorweb\src\main\web\src\main.ts */"./src/main.ts");
